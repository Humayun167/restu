    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Welcome to Tasty Restaurant. You are now logged in.",
        });
        
        // Navigate to home page (user is auto-logged in after registration)
        navigate("/");
      } else {
        ...
        <Card className="shadow-2xl border-0 bg-card/95 backdrop-blur">
          <CardHeader className="text-center space-y-4">
            <div className="flex justify-center">
              <img src={logo} alt="Tasty Restaurant" className="h-12 w-auto" />
            </div>
            <div>
              ...
              <CardDescription className="text-foreground/60 mt-2">
                Join Tasty Restaurant and start your culinary journey
              </CardDescription>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-card px-2 text-foreground/50">Or sign up with</span>
              </div>
            </div>
